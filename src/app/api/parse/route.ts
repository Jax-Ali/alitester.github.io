...
Ты должен найти все вопросы и варианты ответов.
Требования:
- Массив объектов, каждый объект имеет поля: "text" (строка, сам вопрос), "options" (массив строк, варианты ответов).
- Если в тексте явно не указан правильный ответ для какого-то вопроса, не пытайся его угадать.
